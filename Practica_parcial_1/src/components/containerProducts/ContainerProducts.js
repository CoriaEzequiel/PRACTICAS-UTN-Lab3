...
const ContainerProducts = () => {
    ...
    return (
        <div>
            <ProductForm  productos={productos} setProductosHandler={setProductosHandler}/> 
            <Cart productos={productos} setProductosHandler={setProductosHandler}/>
        </div>
    ) //pasamos por props y ahora ProductForm yCart tienen acceso a la lista actual de productos 
    //y pueden actualizar esa lista utilizando la funcion setProdcutosHandler
}
